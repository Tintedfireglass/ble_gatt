...
static const ble_uuid128_t adc_svc_uuid =
    BLE_UUID128_INIT(0x00, 0x00, 0x00, 0x00, 0x11, 0x11, 0x11, 0x11,
                     0x22, 0x22, 0x22, 0x22, 0x44, 0x44, 0x44, 0x44);

static const ble_uuid128_t adc_chr_uuid =
    BLE_UUID128_INIT(0x00, 0x00, 0x00, 0x00, 0x11, 0x11, 0x11, 0x11,
...
/* Service and characteristic values */
                ...
                struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    ...
    case BLE_GATT_ACCESS_OP_READ_CHR:
        ...
        } else if (attr_handle == adc_value_handle) {
            MODLOG_DFLT(INFO, "Reading ADC value: %d\n", adc_value);
            rc = os_mbuf_append(ctxt->om,
                                &adc_value,
                                sizeof(adc_value));
            return rc == 0 ? 0 : BLE_ATT_ERR_INSUFFICIENT_RES;
